                    ...
                    if (isset($_POST["submit"])){
                        ...
                        if ($berat_badan== null || $tinggi_badan== null){
                            ...
                            if ($bmi <= 18.4){
                                ...
                                $hasil="Normal";
                            }elseif ($bmi >= 25.0 and $bmi <= 39.9){
                                $hasil="Overweight";
                            }elseif ($bmi >= 40){
                                $hasil="Obese";
                            }
                            if (isset($_POST['submit'])){
                                echo "Tinggi Anda: $tinggi_badan";
                                echo "<br/>";
                                echo "Berat Anda: $berat_badan";
                                echo "<br/>";
                                echo "Status berat badan: $hasil";
                                echo "<br/>";
                            ...
                            // display jika data kosong
                                ...
                                $error = "Tinggi badan atau berat badan tidak boleh kosong.";
                                echo $error;
                            }
